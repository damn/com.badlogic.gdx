...
(defn getRenderOffsetX
  [^TiledMapTileLayer layer]
  (.getRenderOffsetX layer))

(defn getRenderOffsetY
  [^TiledMapTileLayer layer]
...
(defn setCell
  [^TiledMapTileLayer layer x y ^TiledMapTileLayer$Cell cell]
  (.setCell layer (int x) (int y) cell))

(defn setName
  [^TiledMapTileLayer layer ^String name]
  (.setName layer name))

(defn setVisible
  [^TiledMapTileLayer layer visible?]
